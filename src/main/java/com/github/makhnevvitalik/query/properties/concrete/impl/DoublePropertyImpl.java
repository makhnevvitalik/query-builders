...
public class DoublePropertyImpl<T extends Partial<T>> extends NumberPropertyImpl<T, Double>
    implements DoubleProperty<T> {

    public DoublePropertyImpl(T partial, AbstractNode field) {
        super(partial, field);
    }
}
